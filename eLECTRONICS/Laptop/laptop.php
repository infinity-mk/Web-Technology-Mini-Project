        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="dell.php" class="list-group-item">DELL</a>
                    <a href="lenp.php" class="list-group-item">LENOVO</a>
                    <a href="acer.php" class="list-group-item">ACER</a>
                    <a href="hp.php" class="list-group-item">HP</a>
