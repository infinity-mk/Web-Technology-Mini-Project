<?php include('Mobile/mobile.php');?>
  ...
  <div class="col-md-9">
    <div><center><h2><font face="Trebuchet" size="+3.2" color="#191970" style="text-transform: uppercase;">Samsung</font></h2></center></div>
    ...
    $subcatg="sam";
     ...
     <b>Item No:</b>".$arr['itemno'].
       ...
       <br><a href='cart.php'><img src='images/MetalPlakDa5new.gif' width='70' height='20'/></a>
