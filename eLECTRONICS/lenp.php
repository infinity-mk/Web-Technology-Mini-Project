<?php include('Laptop/laptop.php');?>
            <div class="col-md-9">
              ...
              <div><center><h2><font face="Trebuchet" size="+3.2" color="#191970" style="text-transform: uppercase;">Lenovo</font></h2></center></div>
              ...
              $subcatg="lenp";
                 ...
                 <img src='admin/itempics/$i.jpg' height='200' width='180'><br/>
               ...
               <b>Item No:</b>".$arr['itemno'].
                 ...
                 <br><br><a href='cart.php'><img src='images/MetalPlakDa5new.gif' width='70' height='20'/></a>
                    <a href='viewitem.php?itemno=$i'><img src='images/view7.jpg' width='70' height='20'/></a><br><br>
