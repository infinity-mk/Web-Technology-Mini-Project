...
a:hover{background-color:#2d6898}

</style>
</head>
<body bgcolor="#808A87" style="height:100%">
<div style="width:100%;float:left">
<div style="width:13%;float:left"><img src="usepics/9.jpg" width="182" height="166"/></div>
<div style="width:86.25%;height:27%;float:right;background-color:#212121">
...
<br /><br /><br /><br/>
    <a href="?con=hm"><font color="#F5F5F5" size="+2">Home</font></a>&nbsp;&nbsp;&nbsp;&nbsp; 
	<a href="?log=out"><font color="#F5F5F5" size="+2">LogOut</font></a>
  </div>
</div>
</div>
...
<div style="width:13.7%;height:100%;float:left;background-color:#212121">
  <div align="center"><br />
      <br />
      <a href="?con=add"><font color="#F5F5F5" size="+2">Add Item</font></a><br/>
    <br />

    <a href="?con=view"><font color="#F5F5F5" size="+2">View All</font>
	</a><br/><br/>
	 <a href="?con=ord"><font color="#F5F5F5" size="+2">Orders(
	 <?php
	 include("config.php");
$count=0;
...
echo $count;
	...
	<br/><br/>
	 <a href="?con=fdbk"><font color="#F5F5F5" size="+2">Feedback(
	 <?php
	 include("config.php");
$count=0;
