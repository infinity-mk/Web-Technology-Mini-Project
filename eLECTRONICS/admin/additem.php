...
if($_REQUEST['sub'])
  {
    if(mysql_query("insert into items  values('$catg','$subcatg','$img','$itemno','$price','$desc','$info','$t') "))
	   {
...
<tr>
<td><span class="style3">Info:</span></td>
<td><textarea name="text2" cols="35" rows="6"></textarea></td></tr>
